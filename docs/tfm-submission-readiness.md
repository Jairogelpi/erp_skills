...
**Commit de entrega registrado (2026-08-27):** `e930c7d2ca07bcde7d02c580bd8ee458b3e65eec` (branch `product-demo-unified-v2`). Ya insertado en Anexo A del DOCX y en el README (sección "TFM delivery freeze"). Cualquier commit posterior a este no está cubierto por la memoria entregada — si se toca código, resultados o protocolo después de este punto, repetir §2 y esta sección con el nuevo SHA.