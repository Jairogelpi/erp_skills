...
* **Evidencia:** `python -m pytest` → **186 passed**; `ruff`/`mypy` limpios (29 archivos, un error de tipo real corregido con tipado, no silenciado). Trazabilidad: §19, §20, P9.1.
* **Siguiente paso:** sin cambios respecto a la unidad 21 — cliente LLM real para el protocolo confirmatorio; tokens/latencia (H2/H8); rúbrica automática (H7); kappa humano; memoria.
